        ...
        <>
            <section className="h-section bg-[#673de6] dark:bg-gray-900 -mt-12 md:-mt-28">
                <div className="maxMd:pt-16 px-4 mx-auto h-container text-center lg:px-12">
                    <h1 className="mb-4 text-2xl font-bold leading-none text-white md:text-3xl lg:text-5xl">Login in to your account</h1>
                    <p className="mb-8 text-lg font-normal text-white lg:text-xl sm:px-16 xl:px-48">Not a member yet? <NavLink to={'/register'} className="hover:text-pink-300 hover:underline">Register now!</NavLink></p>
                </div>
            </section>
                        ...
                        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                            <form class="space-y-4 md:space-y-6" method="post">
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-start">
                                        ...
                                        <div class="ml-3 text-sm">
                                            <label for="remember" class="text-gray-500 dark:text-gray-300 select-none">Remember me</label>
                                        </div>
                                    </div>
                                    <NavLink to={'/login'} class="text-sm font-medium text-purple-600 hover:underline dark:text-purple-500">Forgot password?</NavLink>
                                </div>
                                ...
                                <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                                    Don’t have an account yet? <NavLink to={'/register'} class="font-medium text-purple-600 hover:underline dark:text-purple-500">Register</NavLink>
                                </p>
                            </form>
                        </div>
                    </div>
