                    ...
                    <dl class="grid gap-10 min568:grid-cols-2 md:grid-cols-3">
                        {
                            offers.map(offer => {
                                return (
                                    <>
                                        <div class="flex flex-col items-start justify-between gap-6 border border-gray-200 rounded-lg p-8 cursor-pointer hover:bg-slate-50 hover:shadow-[0_10px_26px_-2px_rgba(0,0,0,.1)] transition-all">
                                            <div>
