    ...
    return (
        <>
            <section className="h-section h-hero bg-white dark:bg-gray-900 -mt-12 md:-mt-28">
                <motion.div ref={constraintsRef} className="z-50 maxMd:pt-16 px-4 mx-auto h-container text-center lg:px-12">
                    ...
                    <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                        <motion.a whileTap={{ scale: .9 }} drag dragConstraints={constraintsRef} href="#" className="inline-flex justify-center items-center py-4 px-10 text-base font-medium text-center text-white rounded-full bg-pink-700 hover:bg-pink-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-pink-500">
                            Learn more
